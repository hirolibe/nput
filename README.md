...
- また、学習記録として位置づけることでノート共有のハードルが下がり、コミュニティへの積極的な貢献が促進されます。
...
- アカウント登録により利用できる機能は、「ノート保存・コメント投稿・フォロー・プロフィール更新・画像アップロード」です。
...
（UI/UXは「Zenn」や「Qiita」などの既存のサービスを参考に設計しています）
...
- durationsテーブルを設けて、期間ごとの学習時間を記録
