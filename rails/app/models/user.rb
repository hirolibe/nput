class User < ApplicationRecord
  ...
  validates :terms_version, presence: true, unless: :is_guest?
  validates :privacy_version, presence: true, unless: :is_guest?
  validates :agreed_at, presence: true, unless: :is_guest?
